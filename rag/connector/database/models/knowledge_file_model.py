...
class KnowledgeFileModel(Base):
    ...
    type = Column(String(20), default='file', comment='文件类型(file/url)')
    ...
    def __repr__(self):
        return f"<KnowledgeFile(id='{self.id}', file_name='{self.file_name}', type='{self.type}', file_ext='{self.file_ext}', kb_name='{self.kb_name}', document_loader_name='{self.document_loader_name}', text_splitter_name='{self.text_splitter_name}', file_version='{self.file_version}', create_time='{self.create_time}')>"
