...
from comps import ChatQnAGateway, MicroService, ServiceOrchestrator, ServiceType, CustomLogger
from langchain_core.prompts import PromptTemplate

logger = CustomLogger("chatqna")
class ChatTemplate:
    @staticmethod
...
def align_outputs(self, data, cur_node, inputs, runtime_graph, llm_parameters_dict, **kwargs):
    ...
    if self.services[cur_node].service_type == ServiceType.EMBEDDING:
        ...
        reranked_docs = []
        logger.info("docs========")
        logger.info(json.dumps(docs, indent=2))
        logger.info("data========")
...
def align_generator(self, gen, **kwargs):
    ...
    # b'data:{"id":"","object":"text_completion","created":1725530204,"model":"meta-llama/Meta-Llama-3-8B-Instruct","system_fingerprint":"2.0.1-native","choices":[{"dataprep":0,"delta":{"role":"assistant","content":"?"},"logprobs":null,"finish_reason":null}]}\n\n'
    for line in gen:
...
if __name__ == "__main__":
    # multiprocessing.set_start_method("spawn")  # 确保使用兼容模式
